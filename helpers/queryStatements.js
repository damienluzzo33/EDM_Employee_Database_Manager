...
let getBudgetByDepartment = `SELECT d.dept_name AS department, SUM(r.salary) AS utilized_budget FROM employees e LEFT JOIN roles r ON r.id = e.role_id LEFT JOIN departments d ON r.department_id = d.id GROUP BY d.dept_name;`;

module.exports = { selectEmployees, selectRoles, selectDepartments, employeeNames, roleTitles, departmentNames, getAllManagers, getBudgetByDepartment };
